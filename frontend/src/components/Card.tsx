...
export default function Card(flightsData: IFlight[]) {
  return (
        <section>
          {/* Lista de Voos */}
          <div className="space-y-4">
            {flightsData.map((flight, index) => (
              <div key={index} className="bg-[#1C1C1C] rounded-lg p-6 grid grid-cols-2 md:grid-cols-5 items-center gap-y-6 gap-x-4">
