...
const Card = forwardRef<HTMLAnchorElement, CardProps>(({ flight, className }, ref) => {
  return (
    <Link ref={ref} href={`/flights/${flight.id}`} className={`grid bg-[#212121] rounded-[5px] border-[1px] border-[#444444] pt-[16px] pr-[24px] pb-[24px] pl-[24px] grid-cols-2 md:grid-cols-5 items-center gap-[24px] font-manrope text-[#FFFFFF] w-full max-w-[1147px] h-auto md:h-[94px] transition-all duration-200 ease-in-out hover:border-yellow-500 hover:scale-[1.01] ${className}`}>
